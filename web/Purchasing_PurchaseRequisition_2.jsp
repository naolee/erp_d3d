      ...
      <div class="row">
        <div class="col-md-12 darkbg radius5">
          <ul class="breadcrumb" style="margin-bottom:0px;margin-top:0px">
            ...
            <li class="breadcrumb-item active">Existing Vendor &amp; New Material</li>
          </ul>
        </div>
      </div>
    </div>
          ...
          <div class="tab-content">
            <div class="tab-pane fade show active" id="create" role="tabpanel">
              <ul class="nav nav-tabs py-2">
                ...
                <li class="nav-item">
                  <a href="" class="<%= session.getAttribute("create2tab")%> nav-link" onclick="<%= session.getAttribute("create2submit")%>" data-toggle="pill" data-target="#create2">2. Vendor's Material</a>
                </li>
                <li class="nav-item ">
