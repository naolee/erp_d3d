      ...
      <div class="row">
        <div class="col-md-12 darkbg radius5">
          <ul class="breadcrumb" style="margin-bottom:0px;margin-top:0px">
            ...
            <li class="breadcrumb-item active">Stock Requirement List</li>
          </ul>
        </div>
      </div>
    </div>
                    ...
                    <table id="dsd" width="100%">
                      <tbody>
                        <tr>
                          ...
                          <td colspan="3">
                            <input readonly id="mat_id" name="mat_id" value='<%= session.getAttribute("mat_id")%>' type="text" class="form-control text-capitalize" placeholder="&nbsp;Enter Material Name " required="required"> </td>
                        </tr>
                        <tr>
                          <td class="padd"> <label class="fbold">Material name</label> </td>
                          <td colspan="3">
                            ...
                            <table id="example1234" class="tablefixed table table-striped">
                               <thead>
                                 <tr>
                                   ...
                                   <th class="text-center table-light">Sub-Function</th>
                                 </tr>
                               </thead>
                               <tbody>
